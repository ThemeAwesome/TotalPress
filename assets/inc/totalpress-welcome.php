...
if ( ! function_exists('totalpress_theme_info')) {
    function totalpress_theme_info() {
        $menu_title = esc_html__('TotalPress','totalpress');
        add_theme_page( esc_html__('TotalPress','totalpress'),$menu_title,'edit_theme_options','totalpress','totalpress_theme_info_page');
    }
...
?>
    <div class="wrap about-wrap theme_info_wrapper">
        <h1><?php printf( esc_html__('%s %1s', 'totalpress'), $theme_data->Name, $theme_data->Version ); ?></h1>
        ...
        <h2 class="nav-tab-wrapper">
            ...
            <a href="?page=totalpress&tab=primo" class="nav-tab<?php echo $tab == 'primo' ? ' nav-tab-active' : null; ?>"><?php esc_html_e('Try TP Primo for FREE!','totalpress' ); ?></span></a>
