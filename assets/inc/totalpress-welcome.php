...
if ( ! function_exists( 'totalpress_admin_notice' ) ) {
    function totalpress_admin_notice() { 
        ...
        <div class="update notice notice-success notice-alt is-dismissible">
            <p><?php printf( esc_html__('Thank you for choosing %1$s! Please take a minute and visit %2$s','totalpress'),  $theme_data->Name, '<a class="button button-primary" style="text-decoration: none;" href="'.esc_url( add_query_arg( array( 'page' => 'totalpress' ), admin_url('themes.php'))).'">'.esc_html__('About TotalPress','totalpress').'</a>'); ?>.</p>
        </div>
        <?php
    }
}
