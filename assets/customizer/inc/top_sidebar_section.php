...
TotalPress_Kirki::add_section( 'top_sidebar_layout_section', array(
...
TotalPress_Kirki::add_field('theme_customizer',array(
	'type'        => 'select',
	'settings'    => 'top_sidebar_container',
...
TotalPress_Kirki::add_field('theme_customizer',array(
	'type'        => 'select',
	'settings'    => 'inner_top_sidebar_container',
...
TotalPress_Kirki::add_field('theme_customizer',array(
	...
	'settings'    => 'top_sidebar_alignment',
